...
function ProjectCard({ project, index }: { project: Project; index: number }) {
  ...
  return (
    ...
    >
      <motion.div
        style={{ scale }}
        className="h-full rounded-[40px] sm:rounded-[50px] md:rounded-[60px] border-2 border-[#D7E2EA] bg-[#0C0C0C] p-4 sm:p-6 md:p-8 flex flex-col gap-4 sm:gap-6 origin-top"
      >
        {/* Top row */}
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div className="flex items-center gap-4 sm:gap-6">
            ...
            <div className="flex flex-col gap-1">
              ...
              <h3 className="text-[#D7E2EA] font-medium uppercase" style={{ fontSize: 'clamp(1.25rem, 3vw, 2.5rem)' }}>
                {project.name}
              </h3>
            </div>
          </div>
...
export default function ProjectsSection() {
  return (
    ...
    >
      <FadeIn as="h2" className="hero-heading font-black uppercase leading-none tracking-tight text-center mb-16 sm:mb-20 md:mb-24" style={{ fontSize: 'clamp(3rem, 12vw, 160px)' }}>
        Project
      </FadeIn>
